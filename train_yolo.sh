...
torchrun --nproc_per_node=8 train_aux.py --workers 8 --batch-size 32 --data data_11_sim.yaml --img-size 1536 1536 --epochs 5 --cfg cfg/training/yolov7-w6.yaml --weights yolov7-w6.pt --name yolov7x-w6-v11_sim. --hyp data/my_hyp.yaml --project /workspace/kaggle_benetech/logs

# torchrun --nproc_per_node=8 train_aux.py --workers 8 --batch-size 32 --data data_8_sim.yaml --img-size 1024 1024 --epochs 5 --cfg cfg/training/yolov7-w6.yaml --weights yolov7-w6.pt --name yolov7x-w6-v8_sim. --hyp data/my_hyp.yaml --project /workspace/kaggle_benetech/logs

# echo 

# torchrun --nproc_per_node=8 train_aux.py --workers 8 --batch-size 32 --data data_8_sim.yaml --img-size 640 640 --epochs 5 --cfg cfg/training/yolov7-w6.yaml --weights yolov7-w6.pt --name yolov7x-w6-v8_sim. --hyp data/my_hyp.yaml --project /workspace/kaggle_benetech/logs
